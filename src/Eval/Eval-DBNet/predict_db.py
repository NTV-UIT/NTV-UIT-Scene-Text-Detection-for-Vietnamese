...
if __name__ == "__main__":
    ...
    args.det_model_dir = "./inference/resnet50_bkai_only"
    # args.det_box_type = "poly"
    args.det_db_box_thresh = 0.3
    args.det_db_thresh = 0.3
    args.det_db_max_candidates = 2000
    args.det_db_unclip_ratio = 1.5
    # args.det_db_score_mode = "slow"   
    # Get image file list
    image_file_list = [
        os.path.join(r"E:\Docs\CVA\PaddleOCR\train_data\data_test\private_test_imgs", file)
        for file in os.listdir(r"E:\Docs\CVA\PaddleOCR\train_data\data_test\private_test_imgs")
    ]
    total_time = 0
    ...
    for idx, image_file in enumerate(image_file_list):
        ...
        for index, img in enumerate(imgs):
            ...
            if len(dt_boxes) > 0:
                ...
                output_file = r"E:\Docs\CVA\PaddleOCR\train_data\results\resnet50_bkai_only.txt"
