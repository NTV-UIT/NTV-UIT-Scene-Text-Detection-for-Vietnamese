...
def predict(img):
    ...
    args.det_model_dir = r"E:\Docs\CVA\App\checkpoint\resnet50_finetune"
    args.db_box_thresh = 0.2
    args.db_thresh = 0.1
    total_time = 0
    # create logger
...
if __name__ == "__main__":
    predict(r"E:\Docs\CVA\PaddleOCR\train_data\data_test\private_test_imgs\img_1.jpg")